      ...
      if (this != x$1) {
         label52: {
            ...
            if (var3) {
               label35: {
                  label34: {
                     ExtractedEither var4 = (ExtractedEither)x$1;
                     Either var10000 = this.either();
                     Either var5 = var4.either();
                     if (var10000 == null) {
                        if (var5 != null) {
                           break label34;
                        }
